...
#import "WorldRenderer_shared.h"
#import "WorldRendererUtilities.metal"
#define GAME_TIME 1.1f

static float3 GetWorldPositionAndViewDirFromDepth(uint2 tid, float depth, constant Uniforms& uniforms, thread float3& outViewDirection)
{
    float4 ndc;
...
float evaluate_shadow(constant Uniforms&   globalUniforms,
...
kernel void mousePositionUpdate(depth2d<float, access::read> depthBuffer [[texture(0)]],
                                constant Uniforms& globalUniforms    [[buffer(0)]],
